...
<body style="padding-bottom:0px" onload="loadArticle()">
<div class="container">
...
<div class="container">
	...
	<div class="blog-post" id = "articleContainer">

	</div>

	</div>
</div>
	<div style=" bottom :0;width:100%;text-align:center;vertical-align:middle;margin-right: auto;
	  margin-left: auto;">
